...
STATUS_DELETED = "deleted"      # file removed, album unmonitored
...
def process(row, subsonic, lidarr, *, apply_changes, unmonitored):
    ...
    if match is None:
        logger.warning("SKIP  %s: no unambiguous lidarr track file for %s", label, path)
        return STATUS_UNMATCHED, None
